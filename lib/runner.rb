...
while game_start == true
  ...
  ## GAME BEGINS
    ...
    puts "* * User wins, computer defeated! * *" if cpu_hit_count == cpu_ships.map{|ship| ship.health}.sum
    puts "* * Game Over! Computer wins! * *" if user_hit_count == user_ships.map{|ship| ship.health}.sum
    puts "\n"
